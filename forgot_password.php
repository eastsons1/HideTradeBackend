...
if(isset($_POST['Reset']))
{
			 ...
			 $query = $conn->query("SELECT * FROM user_info WHERE email ='".$_POST['emailid']."' ");
			 
			 if(mysqli_num_rows($query)>0)
			 {
				 $subject  = "Reset Password Link";
				 
				 $link = '<a href="https://refuel.site/projects/tutorapp/update_password.php?email="."'.$_POST['emailid'].'">';
			
				$message = '<table border="0" >

				<tr><td></td><td><strong>Reset Password Link</strong></td></tr>
				...
				$to	=	"pushpendra@eastsons.com".",".$_POST['emailid'];	
