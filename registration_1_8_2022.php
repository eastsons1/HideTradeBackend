	...
	if(isset($_POST['Submit']))
	{
		...
		if( $fname!="" && $email!="" && $mobile!="" && $password != "")
		{
		  ...
		  if($email_already_exits == 0)	
		  {
			 ...
			 $sql = "insert into user_info_temp set first_name ='".$fname."', adminusername ='".$email."', email = '".$email."', password ='".$password."', mobile ='".$mobile."', user_roll	= '0', OTP = '".$randomNumber_otp."', OTP_mobile = '".$randomNumber_otp_mobile."'  ";
