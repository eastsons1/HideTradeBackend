...
include('../include/config.php');
	...
	if(isset($_POST['Submit']))
	{
		...
		$query="SELECT * FROM grade where grade_name ='".$grade_name."'";
		$query_res=$conn->query($query);
		
		if(mysqli_num_rows($query_res)>0)
		{
		
		$msg1 = '<span style="color:red;">This grade  name already exits.Please try other grade  name.</span>';
		}
		else
		{
		
		$sql     =  " UPDATE grade SET grade_name = '".$grade_name."' where id ='".$_GET['id']."' ";
		...
		$fetch     =  "SELECT * FROM grade where id ='".$_GET['id']."'";
...
{	
	...
	if(document.frm.grade_name.value=="")
	{
		alert("Please enter grade name.");
		document.frm.grade_name.focus();
		return false;
	}
						 ...
						 <div class="col-lg-12 col-md-10 col-sm-8">
							...
							<div class="row clearfix">
                                ...
                                <div class="col-lg-2 col-md-2 col-sm-4 form-control-label">
                                    <label for="email_address_2">Grade Name:</label>
                                </div>
                                <div class="col-lg-10 col-md-10 col-sm-8">
                                    <div class="form-group">
                                        <input type="text" id="grade_name" name="grade_name" class="form-control" value="<?php echo $query_res['grade_name']; ?>" placeholder="Enter Grade Name" autocomplete="off" >
                                    </div>
                                </div>
                            </div>
