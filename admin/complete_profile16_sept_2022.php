		 ...
		 <?php include("header-top.php"); ?>
          ...
          <div class="pcoded-main-container">
			...
			<form name="myForm2" method="post" enctype="multipart/form-data" onsubmit="return validate2();">
				...
				<input type="text" class="form-control" value="<?php echo $stu_rec_get_result2['student_name']; ?>" id="student_name" name="student_name" placeholder="Student's Name" autocomplete="off">
				</div>
