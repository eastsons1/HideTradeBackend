		...
		<form name="frm" method="post">
			<table class="table table-hover" >
			  ...
			  <tr>
				...
				{					
					$sql_user = "SELECT * FROM chat_users_details where student_id = '".$_SESSION['loggedIn_user_id']."'  order by id DESC";
				}
                   ...
                   <div id="group_1"><table width="100%" cellpadding="0" cellspacing="0" border="0">
                    ...
                    <?php
						...
						while($data_user = mysqli_fetch_array($res_user))
						{
							...
							if($_SESSION['user_type']=='tutor')
							{					
								$tutor_name = mysqli_fetch_array($conn->query("SELECT first_name,last_name FROM user_info where user_id = '".$data_user['student_id']."' "));
							}
