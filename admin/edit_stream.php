...
include('../include/config.php');
	...
	if(isset($_POST['Submit']))
	{
		...
		$sql     =  " UPDATE stream SET stream_name = '".$stream_name."' where id ='".$_GET['id']."' ";
		...
		$fetch     =  "SELECT * FROM stream where id ='".$_GET['id']."'";
							...
							<div class="row clearfix">
                                ...
                                <div class="col-lg-10 col-md-10 col-sm-8">
                                    <div class="form-group">
                                        <input type="text" id="stream_name" name="stream_name" class="form-control" value="<?php echo $query_res['stream_name']; ?>" placeholder="Enter Stream Name" autocomplete="off" >
                                    </div>
                                </div>
                            </div>
