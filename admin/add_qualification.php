...
//$db = new MySqlDb;
	...
	if(isset($_POST['Submit']))
	{
		...
		{
		 $sql  = " INSERT INTO Qualification set Qualification = '".$Qualification."' ";
							...
							<div class="row clearfix">
                                ...
                                <div class="col-lg-9 col-md-9 col-sm-8">
                                    <div class="form-group">
                                        <input type="text" id="Qualification" name="Qualification" class="form-control" placeholder="Enter Qualification name" autocomplete="off" >
                                    </div>
                                </div>
                            </div>
