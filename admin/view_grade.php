	...
	if(isset($_POST['deleteAll']))
	{
		for($i=0;$i<=count($_POST['numbers']);$i++)
		{
			if($_POST['numbers'][$i]!="")
			{
				 ...
				 $sql_multi_delete4 = "DELETE FROM grade WHERE id = '".$_POST['numbers'][$i]."'";
                                            ...
                                            <div class="col-xl-12 col-md-12">
                                                <div class="card table-card">
                                                    <div class="card-header">
                                                        <h5>View List of School Grade</h5>
			  ...
			  <tr>
				...
				$offset = ($pageNum - 1) * $rowsPerPage; 
				 ...
				 if($search !='')
					...
					$sql_user = "SELECT * FROM grade WHERE grade_name like '".$search."%' ";
				 ...
				 <?php
                   ...
                   <div id="group_1"><table width="100%" cellpadding="0" cellspacing="0" border="0">
                      ...
                      <tr bgcolor="<?php echo $bgcolor;?>">
						...
						<td width="367" align="left" class="paddLt15 paddTopBot5 bodrBot"><strong>
                          <?php 
							...
							{
							?>
                          <img src="images/up.gif" border="0" align="baseline" />&nbsp;<a href="view_grade.php?sort=1&amp;ord=DESC&amp;page=<?php echo $pageNum;?>">Grade Name</a>
                          <?php   
							}
							elseif($_GET['ord']=='DESC' && $_GET['sort']=='1')
							{
							?>
                          <img src="images/down.gif"  border="0" align ="baseline" />&nbsp;<a href="view_grade.php?sort=1&amp;ord=ASC&amp;page=<?php echo $pageNum;?>">Grade Name</a>
                          <?php
							}
							else
							{
							?>
						  <strong><a href="view_grade.php?sort=1&amp;ord=DESC&amp;page=<?php echo $pageNum;?>">Grade Name</a></strong>
						  <?php
							}
							?>
                        </strong></td>
                    ...
                    <tr bgcolor="<?php echo $bgcolor;?>" id="<?php echo $data_user['id'];?>">
						...
						<td width="367"  align="left" class="paddLt15 paddBot11 paddTop5" valign="middle"><?php echo ucfirst($data_user['grade_name']); ?></td>
						
						<td width="144"  align="center" class="paddBot11 paddTop5" valign="middle">
						
					
						<a  href="edit_grade.php?id=<?php echo $data_user['id']; ?>&page=<?php echo $pageNum; ?>" ><img src="images/edit1.png" title="Edit School Level" border="0" style="width:17px; height:17px;" />   </a>	
