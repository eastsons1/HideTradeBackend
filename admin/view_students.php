	...
	if(isset($_POST['deleteAll']))
	{
		for($i=0;$i<=count($_POST['numbers']);$i++)
		{
			if($_POST['numbers'][$i]!="")
			{
				 ...
				 $sql_multi_delete4 = "DELETE FROM user_student_info WHERE id = '".$_POST['numbers'][$i]."'";
			...
			<table class="table table-hover" >
			  ...
			  <tr>
				...
				$offset = ($pageNum - 1) * $rowsPerPage; 
					...
					$sql_user = "SELECT * FROM user_info as uinf INNER JOIN user_student_info as utinf ON uinf.user_id = utinf.user_id order by utinf.id DESC";
				 ...
				 if($search !='')
					{ 
						...
						$sql_user = "SELECT * FROM user_info as uinf INNER JOIN user_student_info as utinf ON uinf.user_id = utinf.user_id WHERE utinf.student_name like '".$search."%' ";
				...
				if($_GET['sort']==1)
				{ 
					$sql_user .=" ORDER BY student_name ";
				}
				 ...
				 <?php
                   ...
                   <div id="group_1"><table width="100%" cellpadding="0" cellspacing="0" border="0">
                      ...
                      <tr bgcolor="<?php echo $bgcolor;?>">
						...
						<td width="367" align="left" class="paddLt15 paddTopBot5 bodrBot"><strong>
                          <?php 
							...
							{
							?>
                          <img src="images/up.gif" border="0" align="baseline" />&nbsp;<a href="view_tutor.php?sort=1&amp;ord=DESC&amp;page=<?php echo $pageNum;?>">Student Name </a>
                          <?php   
							}
							elseif($_GET['ord']=='DESC' && $_GET['sort']=='1')
							{
							?>
                          <img src="images/down.gif"  border="0" align ="baseline" />&nbsp;<a href="view_tutor.php?sort=1&amp;ord=ASC&amp;page=<?php echo $pageNum;?>">Student Name</a>
                          <?php
							}
							else
							{
							?>
						  <strong><a href="view_tutor.php?sort=1&amp;ord=DESC&amp;page=<?php echo $pageNum;?>">Student Name</a></strong>
						  <?php
							}
							?>
                        </strong></td>
						
						<td width="367"  align="left" valign="middle" class="paddTopBot5 bodrBot"><strong>Profile Image</strong></td>
						<td width="367"  align="left" valign="middle" class="paddTopBot5 bodrBot"><strong>Level</strong></td>
						<td width="367"  align="left" valign="middle" class="paddTopBot5 bodrBot"><strong>Grade</strong></td>
						<td width="367"  align="left" valign="middle" class="paddTopBot5 bodrBot"><strong>Stream</strong></td>
						<td width="367"  align="left" valign="middle" class="paddTopBot5 bodrBot"><strong>Passing Year</strong></td>
						<td width="367"  align="left" valign="middle" class="paddTopBot5 bodrBot"><strong>Subject</strong></td>
					...
					?>
						...
						<td width="367"  align="left" class="paddLt15 paddBot11 paddTop5" valign="middle"><?php echo ucfirst($data_user['student_name']); ?></td>
						<td width="367"  align="left" class="paddLt15 paddBot11 paddTop5" valign="middle">
						<img src="../UPLOAD_file/<?php echo ucfirst($data_user['profile_image']); ?>" style="width:50px;" >
						</td>
						<td width="367"  align="left" class="paddLt15 paddBot11 paddTop5" valign="middle"><?php echo ucfirst($data_user['Level']); ?></td>
						<td width="367"  align="left" class="paddLt15 paddBot11 paddTop5" valign="middle"><?php echo ucfirst($data_user['Grade']); ?></td>
						<td width="367"  align="left" class="paddLt15 paddBot11 paddTop5" valign="middle"><?php echo ucfirst($data_user['Stream']); ?></td>
						<td width="367"  align="left" class="paddLt15 paddBot11 paddTop5" valign="middle"><?php echo ucfirst($data_user['passing_year']); ?></td>
						<td width="367"  align="left" class="paddLt15 paddBot11 paddTop5" valign="middle"><?php echo ucfirst($data_user['Subject']); ?></td>
