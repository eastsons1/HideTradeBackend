			...
			<table class="table table-hover" >
			  ...
			  <tr>
				...
				$offset = ($pageNum - 1) * $rowsPerPage; 
					...
					$sql_user = "SELECT * FROM user_info as uinf INNER JOIN student_post_requirement as spr ON uinf.user_id = spr.user_id ";
				 ...
				 if($search !='')
					...
					$sql_user = "SELECT * FROM user_info as uinf INNER JOIN student_post_requirement as spr ON uinf.user_id = spr.user_id WHERE spr.Qualification like '".$search."%' or spr.Gender like '".$search."%' or spr.frequency_lessons like '".$search."%' or spr.hours like '".$search."%' or spr.Preferred_Time like '".$search."%' or spr.Preferred_Days like '".$search."%' or spr.Fee_Range like '".$search."%' ";
				 ...
				 <?php
                   ...
                   <div id="group_1"><table width="100%" cellpadding="0" cellspacing="0" border="0">
						<tr>
							...
							<tr>
							 <td colspan="7" class="bodrBot" width="50%" align="right">
								  ...
								  <input class="form-control form-control-round" placeholder="Tuition Jobs Search by Qualification, Gender, Lessons, Time, Days ..." type="text" name="search" id="search" style="width: 100%;max-width: 821px;min-width: 821px;float: left;padding: 10px 0 11px 16px;font-size: 22px;">
                      ...
                      <tr bgcolor="<?php echo $bgcolor;?>">
						...
						<td width="367" align="left" class="paddLt15 paddTopBot5 bodrBot"><strong>
                          <?php 
							...
							{
							?>
                          <img src="images/up.gif" border="0" align="baseline" />&nbsp;<a href="view_tuition_jobs.php?sort=1&amp;ord=DESC&amp;page=<?php echo $pageNum;?>">Qualification</a>
                          <?php   
							}
							elseif($_GET['ord']=='DESC' && $_GET['sort']=='1')
							{
							?>
                          <img src="images/down.gif"  border="0" align ="baseline" />&nbsp;<a href="view_tuition_jobs.php?sort=1&amp;ord=ASC&amp;page=<?php echo $pageNum;?>">Qualification</a>
                          <?php
							}
							else
							{
							?>
						  <strong><a href="view_tuition_jobs.php?sort=1&amp;ord=DESC&amp;page=<?php echo $pageNum;?>">Qualification</a><a href="view_schedule.php?sort=1&amp;ord=ASC&amp;page=<?php echo $pageNum;?>"></a></strong>
						  <?php
							}
							?>
                        </strong></td>
							<td width="367"  align="left" valign="middle" class="paddTopBot5 bodrBot"><strong>Gender</strong></td>
								<td width="367"  align="left" valign="middle" class="paddTopBot5 bodrBot"><strong>Frequency Lessons</strong></td>
								<td width="367"  align="left" valign="middle" class="paddTopBot5 bodrBot"><strong>Duration of Lessons</strong></td>
								<td width="367"  align="left" valign="middle" class="paddTopBot5 bodrBot"><strong>Preferred Time</strong></td>
								<td width="367"  align="left" valign="middle" class="paddTopBot5 bodrBot"><strong>Preferred_Days</strong></td>
								<td width="367"  align="left" valign="middle" class="paddTopBot5 bodrBot"><strong>Fee Range</strong></td>
                    ...
                    <tr bgcolor="<?php echo $bgcolor;?>" id="<?php echo $data_user['id'];?>">
						...
						<td width="367"  align="left" class="paddLt15 paddBot11 paddTop5" valign="middle"><?php echo ucfirst($data_user['Qualification'])." ".$data_user['last_name']; ?></td>
						
						<td width="367"  align="left" class="paddLt15 paddBot11 paddTop5" valign="middle"><?php echo $data_user['Gender']; ?></td>
						<td width="367"  align="left" class="paddLt15 paddBot11 paddTop5" valign="middle"><?php echo $data_user['frequency_lessons']; ?></td>
						<td width="367"  align="left" class="paddLt15 paddBot11 paddTop5" valign="middle"><?php echo $data_user['hours'].":".$data_user['minutes']." ".'Hours'; ?></td>
						<td width="367"  align="left" class="paddLt15 paddBot11 paddTop5" valign="middle"><?php echo $data_user['Preferred_Time']; ?></td>
						<td width="367"  align="left" class="paddLt15 paddBot11 paddTop5" valign="middle"><?php echo $data_user['Preferred_Days']; ?></td>
						<td width="367"  align="left" class="paddLt15 paddBot11 paddTop5" valign="middle"><?php echo $data_user['Fee_Range']; ?></td>
