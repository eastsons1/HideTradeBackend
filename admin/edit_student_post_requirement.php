...
include("../include/functions.php");
	...
	if(isset($_POST['Submit2']))
	{
		...
		if($Qualification != "Select Qualification" && $Gender != "Select Gender of Tutor" && $frequency_lessons != "Frequency_Lessons" && $hours != "" && $Preferred_Time != "Select Preferred Time" && $Preferred_Days != "Select Preferred Days" && $Fee_Range != "")
		{
			...
			$sql_inserts     =  " UPDATE student_post_requirement SET Qualification = '".$Qualification."', Gender = '".$Gender."', frequency_lessons ='".$frequency_lessons."', hours ='".$hours."', minutes = '".$minutes."', Preferred_Time ='".$Preferred_Time."', Preferred_Days = '".$Preferred_Days."', Fee_Range = '".$Fee_Range."' WHERE id ='".$_GET['id']."' ";
		...
		{
			$msg1 = '<span style="color:red;">Data not updated successfully.</span>';
		}			
	}		
		
		$fetch     =  "SELECT * FROM student_post_requirement where id ='".$_GET['id']."'";
		$query_run =  $conn->query($fetch);
		$query_res =  mysqli_fetch_array($query_run);
		 ...
		 <?php include("header-top.php"); ?>
          ...
          <div class="pcoded-main-container">
                                            ...
                                            <div class="col-xl-12 col-md-12">
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h5>Edit Student Post Requirement</h5>
			...
			<form name="myForm2" method="post" enctype="multipart/form-data" onsubmit="return validate2();">
				...
				{
				?>
				<option value="<?php echo $query_result['Qualification']; ?>" <?php if($query_result['Qualification']==$query_res['Qualification']){ echo 'selected';} ?> ><?php echo $query_result['Qualification']; ?></option>
				<?php } ?>
				</select>
				</div>
				...
				<option value="Male" <?php if($query_res['Gender']=="Male"){ echo 'selected';} ?> >Male</option>
				<option value="Female" <?php if($query_res['Gender']=="Female"){ echo 'selected';} ?> >Female</option>
				...
				<option value="Home Tuition" <?php if($query_res['frequency_lessons']=="Home Tuition"){ echo 'selected';} ?> >Home Tuition</option>
				<option value="Online Tuition" <?php if($query_res['frequency_lessons']=="Online Tuition"){ echo 'selected';} ?> >Online Tuition</option>
				<option value="Homework Help" <?php if($query_res['frequency_lessons']=="Homework Help"){ echo 'selected';} ?> >Homework Help</option>
				</select>
				</div>
				...
				<input type="text" class="form-control" name="textInput" id="textInput" value="<?php echo $query_res['hours']; ?>" placeholder="Duration of Lessons Hours" style="width:100%; float:left;margin:17px 0 0 0;" autocomplete="off">
				...
				<input type="text" class="form-control" name="textInput2" id="textInput2" value="<?php echo $query_res['minutes']; ?>" placeholder="Duration of Lessons Minutes" style="width:100%; float:left;margin:17px 0 0 0;" autocomplete="off">
				...
				<select type="text" class="form-control"  id="Preferred_Time" name="Preferred_Time" placeholder="Preferred Time" autocomplete="off" ">
				<option value="Select Preferred Time">--Select Preferred Time--</option>
				<option value="Morning" <?php if($query_res['Preferred_Time']=="Morning"){ echo 'selected';} ?> >Morning</option>
				<option value="Afternoon" <?php if($query_res['Preferred_Time']=="Afternoon"){ echo 'selected';} ?> >Afternoon</option>
				<option value="Evening" <?php if($query_res['Preferred_Time']=="Evening"){ echo 'selected';} ?> >Evening</option>
				</select>
				</div>
				...
				<select type="text" class="form-control"  id="Preferred_Days" name="Preferred_Days" placeholder="Preferred Days" autocomplete="off" ">
				<option value="Select Preferred Days">--Select Preferred Days--</option>
				<option value="Monday" <?php if($query_res['Preferred_Days']=="Monday"){ echo 'selected';} ?> >Monday</option>
				<option value="Tuesday" <?php if($query_res['Preferred_Days']=="Tuesday"){ echo 'selected';} ?> >Tuesday</option>
				<option value="Wednesday" <?php if($query_res['Preferred_Days']=="Wednesday"){ echo 'selected';} ?> >Wednesday</option>
				<option value="Thrusday" <?php if($query_res['Preferred_Days']=="Thrusday"){ echo 'selected';} ?> >Thrusday</option>
				<option value="Friday" <?php if($query_res['Preferred_Days']=="Friday"){ echo 'selected';} ?> >Friday</option>
				<option value="Saturday" <?php if($query_res['Preferred_Days']=="Saturday"){ echo 'selected';} ?> >Saturday</option>
				</select>
				</div>
				...
				<input type="text" class="form-control" name="Fee_Range" id="textInput3" value="<?php echo $query_res['Fee_Range']; ?>" placeholder="Fee Range" style="width:100%; float:left;margin:17px 0 0 0;" autocomplete="off">
				...
				<input type="submit" name="Submit2" class="btn waves-effect waves-light hor-grd btn-grd-info" value="Update Requirement">
				</div>		  
