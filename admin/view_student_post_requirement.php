	...
	if(isset($_POST['deleteAll']))
	{
		for($i=0;$i<=count($_POST['numbers']);$i++)
		{
			if($_POST['numbers'][$i]!="")
			{
				 ...
				 $sql_multi_delete4 = "DELETE FROM student_post_requirement WHERE id = '".$_POST['numbers'][$i]."'";
...
function DoAction( id )
{
     ...
     $.ajax({
          type: "GET",
          url: "delete_student_post_requirement.php?id=" + id,
                                            ...
                                            <div class="col-xl-12 col-md-12">
                                                <div class="card table-card">
                                                    <div class="card-header">
                                                        <h5>View Student's Post Requirement</h5>
			...
			<table class="table table-hover" >
			  ...
			  <tr>
				...
				$offset = ($pageNum - 1) * $rowsPerPage; 
					...
					$sql_user = "SELECT * FROM student_post_requirement";
				 ...
				 if($search !='')
					{ 
						...
						$sql_user = "SELECT * FROM student_post_requirement WHERE Qualification like '".$search."%' ";
				 ...
				 <?php
                   ...
                   <div id="group_1"><table width="100%" cellpadding="0" cellspacing="0" border="0">
                      ...
                      <tr bgcolor="<?php echo $bgcolor;?>">
						...
						<td width="367" align="left" class="paddLt15 paddTopBot5 bodrBot"><strong>
                          <?php 
							...
							{
							?>
                          <img src="images/up.gif" border="0" align="baseline" />&nbsp;<a href="view_student_post_requirement.php?sort=1&amp;ord=DESC&amp;page=<?php echo $pageNum;?>">Qualification</a>
                          <?php   
							}
							elseif($_GET['ord']=='DESC' && $_GET['sort']=='1')
							{
							?>
                          <img src="images/down.gif"  border="0" align ="baseline" />&nbsp;<a href="view_student_post_requirement.php?sort=1&amp;ord=ASC&amp;page=<?php echo $pageNum;?>">Qualification</a>
                          <?php
							}
							else
							{
							?>
						  <strong><a href="view_student_post_requirement.php?sort=1&amp;ord=DESC&amp;page=<?php echo $pageNum;?>">Qualification</a></strong>
						  <?php
							}
							?>
                        </strong></td>
						
						<td class="paddTopBot5 bodrBot" width="367" valign="middle" align="left"><strong>Gender</strong></td>
						
						<td class="paddTopBot5 bodrBot" width="367" valign="middle" align="left"><strong>Frequency of Lessons</strong></td>
						
						<td class="paddTopBot5 bodrBot" width="367" valign="middle" align="left"><strong>Duration of Lessons</strong></td>
						<td class="paddTopBot5 bodrBot" width="367" valign="middle" align="left"><strong>Preferred Time</strong></td>
						
						<td class="paddTopBot5 bodrBot" width="367" valign="middle" align="left"><strong>Preferred Days</strong></td>
						<td class="paddTopBot5 bodrBot" width="367" valign="middle" align="left"><strong>Fee Range</strong></td>
                    ...
                    <tr bgcolor="<?php echo $bgcolor;?>" id="<?php echo $data_user['id'];?>">
						...
						<td width="367"  align="left" class="paddLt15 paddBot11 paddTop5" valign="middle"><?php echo ucfirst($data_user['Gender']); ?></td>
						<td width="367"  align="left" class="paddLt15 paddBot11 paddTop5" valign="middle"><?php echo ucfirst($data_user['frequency_lessons']); ?></td>
						...
						<td width="367"  align="left" class="paddLt15 paddBot11 paddTop5" valign="middle"><?php echo ucfirst($data_user['Preferred_Time']); ?></td>
						<td width="367"  align="left" class="paddLt15 paddBot11 paddTop5" valign="middle"><?php echo ucfirst($data_user['Preferred_Days']); ?></td>
						...
						<a  href="edit_student_post_requirement.php?id=<?php echo $data_user['id']; ?>&page=<?php echo $pageNum; ?>" ><img src="images/edit1.png" title="Edit Student Post Requirement" border="0" style="width:17px; height:17px;" />   </a>	
