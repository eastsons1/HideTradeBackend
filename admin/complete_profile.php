	...
	if(isset($_POST['Submit']))
	{
		...
		$tutor_code = $random_character.$random_num;
				...
				{  
					...
					$del_tdsg = $conn->query("delete from tutor_qualification_subject_grade where user_id= '".$_SESSION['loggedIn_user_id']."' ");
					...
					{  
						if(trim($_POST["tutor_Subject"][$i] != ''))
						{
							 ...
							 $a1  = $conn->query("INSERT INTO tutor_qualification_subject_grade set  tutor_qualification_Subject = '".$_POST["tutor_Subject"][$i]."', tutor_qualification_Grade ='".$_POST["tutor_Grade"][$i]."', user_id = '".$_SESSION['loggedIn_user_id']."' ");
				...
				/// Store All data in totoring_grade Start
					...
					{  
						...
						$del_tdsg2grd = $conn->query("delete from tutor_totoring_grade where user_id= '".$_SESSION['loggedIn_user_id']."'  ");
						...
						{  
							if(trim($_POST["totoring_grade"][$i] != ''))
							{
								...
								$TutoringGrade_Sql  = $conn->query(" INSERT INTO tutor_totoring_grade set Tutoring_Grade ='".$_POST["totoring_grade"][$i]."', user_id = '".$_SESSION['loggedIn_user_id']."' ");
					...
					{  
						...
						$del_tdsg2sub = $conn->query("delete from tutor_tutorial_subjects where user_id= '".$_SESSION['loggedIn_user_id']."'  ");
						...
						{  
							if(trim($_POST["Tutoring_Subjects"][$i] != ''))
							{
								...
								$TutoringGrade_sub  = $conn->query(" INSERT INTO tutor_tutorial_subjects set Tutoring_Subjects ='".$_POST["Tutoring_Subjects"][$i]."', user_id = '".$_SESSION['loggedIn_user_id']."' ");
					...
					{  
						...
						$del_tdsg2str = $conn->query("delete from tutor_totoring_stream where user_id= '".$_SESSION['loggedIn_user_id']."'  ");
						...
						{  
							if(trim($_POST["tutoring_Stream"][$i] != ''))
							{
								...
								$TutoringGrade_str  = $conn->query(" INSERT INTO tutor_totoring_stream set Tutoring_Stream ='".$_POST["tutoring_Stream"][$i]."', user_id = '".$_SESSION['loggedIn_user_id']."' ");
					...
					{  
						...
						$del_tdsg2str = $conn->query("delete from tutor_totoring_levels where user_id= '".$_SESSION['loggedIn_user_id']."'  ");
						...
						{  
							if(trim($_POST["Tutoring_Levels"][$i] != ''))
							{
								...
								$Tutoring_Levels_str  = $conn->query(" INSERT INTO tutor_totoring_levels set Tutoring_Level ='".$_POST["Tutoring_Levels"][$i]."', user_id = '".$_SESSION['loggedIn_user_id']."' ");
			...
			if($_FILES['uploadfile_logo']['name']=="")
				{
					$sql22     =  " UPDATE user_tutor_info SET gender = '".$gender."', age = '".$age."', nationality = '".$nationality."', qualification ='".$qualification."', name_of_school = '".$Name_Of_School."', Course_Exam = '".$Course_Exam."', OtherCourse_Exam = '".$OtherCourse_Exam."', tutor_status ='".$Tutor_status."', tuition_type ='".$tuition_type."', location = '".$location."', postal_code = '".$postal_code."', travel_distance = '".$travel_distance."', tutor_tutoring_experience_years = '".$tutor_tutoring_experience_years."', tutor_tutoring_experience_months = '".$tutor_tutoring_experience_months."', personal_statement = '".$Personal_Statements."' where user_id ='".$_SESSION['loggedIn_user_id']."' ";
			
					$UPDATE2 =  $conn->query($sql22);
		...
		{		
			...
			if(mysqli_num_rows($query_runP)>0)
			{
				...
				{
				$sql2     =  " UPDATE user_tutor_info SET gender = '".$gender."', age = '".$age."', nationality = '".$nationality."', qualification ='".$qualification."', name_of_school = '".$Name_Of_School."', Course_Exam = '".$Course_Exam."', OtherCourse_Exam = '".$OtherCourse_Exam."', tutor_status ='".$Tutor_status."', tuition_type ='".$tuition_type."', location = '".$location."', postal_code = '".$postal_code."', travel_distance = '".$travel_distance."', tutor_tutoring_experience_years = '".$tutor_tutoring_experience_years."', tutor_tutoring_experience_months = '".$tutor_tutoring_experience_months."', personal_statement = '".$Personal_Statements."' where user_id ='".$_SESSION['loggedIn_user_id']."' ";
				...
				{
				$sql2     =  " UPDATE user_tutor_info SET gender = '".$gender."', age = '".$age."', nationality = '".$nationality."', qualification ='".$qualification."', name_of_school = '".$Name_Of_School."', Course_Exam = '".$Course_Exam."', OtherCourse_Exam = '".$OtherCourse_Exam."', tutor_status ='".$Tutor_status."', tuition_type ='".$tuition_type."', location = '".$location."', postal_code = '".$postal_code."', travel_distance = '".$travel_distance."', tutor_tutoring_experience_years = '".$tutor_tutoring_experience_years."', tutor_tutoring_experience_months = '".$tutor_tutoring_experience_months."', personal_statement = '".$Personal_Statements."', profile_image = '".$image_name."' where user_id ='".$_SESSION['loggedIn_user_id']."' ";
				...
				$msg1 = '<span style="color:red;">Data updated successfully.</span>';
					...
					if(copy($_FILES['uploadfile_logo']['tmp_name'],$DIR.$image_name))
					{
						$sql_insert     =  " INSERT INTO user_tutor_info SET user_id ='".$_SESSION['loggedIn_user_id']."', gender = '".$gender."', age = '".$age."', nationality = '".$nationality."', qualification ='".$qualification."', name_of_school = '".$Name_Of_School."', Course_Exam = '".$Course_Exam."', OtherCourse_Exam = '".$OtherCourse_Exam."', tutor_status ='".$Tutor_status."', tuition_type ='".$tuition_type."', location = '".$location."', postal_code = '".$postal_code."', travel_distance = '".$travel_distance."', tutor_tutoring_experience_years = '".$tutor_tutoring_experience_years."', tutor_tutoring_experience_months = '".$tutor_tutoring_experience_months."', personal_statement = '".$Personal_Statements."', tutor_code = '".$tutor_code."', profile_image = '".$image_name."' ";
				...
				if(mysqli_num_rows($query_runPs)>0)
				{
					if(!copy($_FILES['uploadfile_logo2']['tmp_name'],$DIR2.$image_nameS))
					{
						...
						if(copy($_FILES['uploadfile_logo2']['tmp_name'],$DIR2.$image_nameS))
						{
							...
							$sql_inserts     =  " INSERT INTO user_student_info SET user_id ='".$_SESSION['loggedIn_user_id']."', student_name = '".$student_name."', Level = '".$Level."', Grade ='".$Grade."', Stream ='".$Stream."', passing_year ='".$passing_year."', Subject = '".$Subject."', country = '".$Student_Nationality."', Student_Location = '".$Student_Location."', Student_Postal_Code = '".$Student_Postal_Code."', profile_image = '".$image_nameS."' ";
		 ...
		 <?php include("header-top.php"); ?>
          ...
          <div class="pcoded-main-container">
			...
			<table width="100%" cellspacing="0" cellpadding="0" border="0">
				...
				<!-- <span style="width: 100%;color: red;font-size: 20px;background: #eee;border-radius: 59px;padding: 2px 12px 6px 7px;">
				
				<?php 
					//$msg_status = mysqli_num_rows($conn->query("select * from chat_users_details where message_status = 0"));  
					//echo '<img src="images/msgicons.png" style="width:24px;">'.$msg_status;
				?>
			   </span>	-->
			...
			{ 
						...
						$student_data_rec = mysqli_fetch_array($conn->query("SELECT * FROM user_info WHERE user_id ='".$_SESSION['loggedIn_user_id']."'  "));
			?>
			...
			<form name="myForm2" method="post" enctype="multipart/form-data" onsubmit="return validate2();">
				...
				<input type="text" class="form-control" value="<?php echo $student_data_rec['first_name']." ".$student_data_rec['last_name']; ?>" id="student_name" name="student_name" placeholder="Student's Name" autocomplete="off">
				</div>
