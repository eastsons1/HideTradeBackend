	...
	if(isset($_POST['deleteAll']))
	{
		for($i=0;$i<=count($_POST['numbers']);$i++)
		{
			if($_POST['numbers'][$i]!="")
			{
				 ...
				 $sql_multi_delete4 = "DELETE FROM school_levels WHERE id = '".$_POST['numbers'][$i]."'";
                                            ...
                                            <div class="col-xl-12 col-md-12">
                                                <div class="card table-card">
                                                    <div class="card-header">
                                                        <h5>View List of School Levels</h5>
			...
			<table class="table table-hover" >
			  ...
			  <tr>
				...
				$offset = ($pageNum - 1) * $rowsPerPage; 
					...
					$sql_user = "SELECT * FROM school_levels";
				 ...
				 if($search !='')
					...
					$sql_user = "SELECT * FROM school_levels WHERE school_level_name like '".$search."%' ";
				...
				if($_GET['sort']==1)
				{ 
				$sql_user .=" ORDER BY school_level_name ";
				}
				 ...
				 <?php
                   ...
                   <div id="group_1"><table width="100%" cellpadding="0" cellspacing="0" border="0">
                      ...
                      <tr bgcolor="<?php echo $bgcolor;?>">
						...
						<td width="367" align="left" class="paddLt15 paddTopBot5 bodrBot"><strong>
                          <?php 
							...
							{
							?>
                          <img src="images/up.gif" border="0" align="baseline" />&nbsp;<a href="view_school_levels.php?sort=1&amp;ord=DESC&amp;page=<?php echo $pageNum;?>">School Level Name</a>
                          <?php   
							}
							elseif($_GET['ord']=='DESC' && $_GET['sort']=='1')
							{
							?>
                          <img src="images/down.gif"  border="0" align ="baseline" />&nbsp;<a href="view_school_levels.php?sort=1&amp;ord=ASC&amp;page=<?php echo $pageNum;?>">School Level Name</a>
                          <?php
							}
							else
							{
							?>
						  <strong><a href="view_school_levels.php?sort=1&amp;ord=DESC&amp;page=<?php echo $pageNum;?>">School Level Name</a><a href="view_schedule.php?sort=1&amp;ord=ASC&amp;page=<?php echo $pageNum;?>"></a></strong>
						  <?php
							}
							?>
                        </strong></td>
                    ...
                    <tr bgcolor="<?php echo $bgcolor;?>" id="<?php echo $data_user['id'];?>">
						...
						<td width="367"  align="left" class="paddLt15 paddBot11 paddTop5" valign="middle"><?php echo ucfirst($data_user['school_level_name']); ?></td>
						
						<td width="144"  align="center" class="paddBot11 paddTop5" valign="middle">
						
					
						<a  href="edit_school_level.php?id=<?php echo $data_user['id']; ?>&page=<?php echo $pageNum; ?>" ><img src="images/edit1.png" title="Edit School Level" border="0" style="width:17px; height:17px;" />   </a>	
