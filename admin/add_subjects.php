...
//$db = new MySqlDb;
	...
	if(isset($_POST['Submit']))
	{
		...
		{
		 $sql  = " INSERT INTO subjects set subjects_name = '".$subjects_name."' ";
          ...
          <div class="pcoded-main-container">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card" style="padding: 3% 8% 18% 5%;">
                    <div class="header">
                        <h2><strong>Add</strong> Subject Name  </h2>
						 ...
						 <div class="col-lg-12 col-md-10 col-sm-8">
							...
							<div class="row clearfix">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-4 form-control-label">
                                    <label for="email_address_2">Subject Name:</label>
                                </div>
                                <div class="col-lg-9 col-md-9 col-sm-8">
                                    <div class="form-group">
                                        <input type="text" id="" name="subjects_name" class="form-control" placeholder="Enter Subjects Name" autocomplete="off" >
                                    </div>
                                </div>
                            </div>
