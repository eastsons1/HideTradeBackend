...
// die();
	...
	if(isset($_POST['deleteAll']))
	{
		for($i=0;$i<=count($_POST['numbers']);$i++)
		{
			if($_POST['numbers'][$i]!="")
			{
				 $sql_multi_delete = "DELETE FROM user_info WHERE user_id = '".$_POST['numbers'][$i]."'";
			  ...
			  <tr>
				...
				if($_SESSION['user_type'] == "Admin")
				{
					...
					//$user_type = $_SESSION['user_type'];
						...
						$query_j = "SELECT user_id FROM user_info WHERE user_id = '".$_SESSION['loggedIn_user_id']."' and user_id <> 1 ";  
