	...
	if(isset($_POST['Submit2']))
	{
		...
		if(mysqli_num_rows($query_runPs)>0)
		{
		  ...
		  $UPDATEs =  $conn->query($sqls2);
			...
			$sql_inserts     =  " INSERT INTO user_student_info SET user_id ='".$_SESSION['loggedIn_user_id']."', student_name = '".$student_name."', Level = '".$Level."', Grade ='".$Grade."', Stream ='".$Stream."', passing_year ='".$passing_year."', Subject = '".$Subject."' ";
				...
				<label class="control-label mb-10" for="exampleInputEmail_2" style="color: #ffaa00;font-size: 22px;" >Tutor Code: <?php echo $data_rec_get_Result['tutor_code']; ?></label>
				  ...
				  <?php
					...
					<label class="control-label mb-10" for="exampleInputName_1">Profile Image</label>
					  ...
					  <img src="../UPLOAD_file/<?php echo $data_rec_get_Result['profile_image']; ?>" style="width:80px;" />&nbsp;<a href="delete_profile.php?id=<?php echo $data_rec_get_Result['user_id'];?>"><img src="images/delete.png" border="0" /></a>
