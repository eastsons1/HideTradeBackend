 ...
 //echo $_SESSION['user_type'];
	...
	if(isset($_POST['Submit']))
	{
		...
		if($_SESSION['user_type']=='student')
		{
		 ...
		 $fetch     =  "INSERT INTO chat_users_details SET tutor_id = '".$_GET['tutor_id']."', student_id = '".$_SESSION['loggedIn_user_id']."', msg_send_user_type = '".$_SESSION['user_type']."', student_name ='".$name."',  student_email = '".$email."', chat_date = '".$dateTime."'  ";
		 
		   $id = "tutor_id=".$_GET['tutor_id'];
		}
		if($_SESSION['user_type']=='tutor')
		{
		
		 $fetch     =  "INSERT INTO chat_users_details SET tutor_id = '".$_GET['student_id']."', student_id = '".$_SESSION['loggedIn_user_id']."', msg_send_user_type = '".$_SESSION['user_type']."', student_name ='".$name."',  student_email = '".$email."', chat_date = '".$dateTime."'  ";
		
		  $id = "student_id=".$_GET['student_id'];
		}
		...
		if($query_run)
		{
			header("location:chat_room.php?".$id);
		}			
    }
              ...
              <div class="pcoded-wrapper">
                  ...
                  <div class="pcoded-content">
                      ...
                      <!-- Page-header end -->
						...
						<form class="form-horizontal" name="frm" method="post" enctype="multipart/form-data" onsubmit="return validate();" >
							<div class="row clearfix">
                               ...
                               <br/><br/><br/>
								...
								?>
									...
									<label class="control-label mb-10" for="exampleInputName_1" style=" width: 100%;"><strong>Enter Your Name</strong></label>
									
									<input type="text" name="name" id="name" class="form-control" style="width: 100%;max-width: 500px;min-width: 500px;"  >
									...
									<label class="control-label mb-10" for="exampleInputName_1" style="width: 100%;max-width: 500px;min-width: 500px;"  ><strong>Enter Your Email </strong></label>
