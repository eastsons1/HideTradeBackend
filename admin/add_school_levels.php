...
//$db = new MySqlDb;
	...
	if(isset($_POST['Submit']))
	{
		...
		{
		 $sql  = " INSERT INTO school_levels set school_level_name = '".$school_level_name."' ";
          ...
          <div class="pcoded-main-container">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card" style="padding: 3% 8% 18% 5%;">
                    <div class="header">
                        <h2><strong>Add</strong> School Level Name </h2>
							...
							<div class="row clearfix">
                                ...
                                <div class="col-lg-9 col-md-9 col-sm-8">
                                    <div class="form-group">
                                        <input type="text" id="" name="school_level_name" class="form-control" placeholder="Enter School Level Name" autocomplete="off" >
                                    </div>
                                </div>
                            </div>
