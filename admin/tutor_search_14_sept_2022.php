				 ...
				 <?php
                   ...
                   <div id="group_1"><table width="100%" cellpadding="0" cellspacing="0" border="0">
                    ...
                    <tr bgcolor="<?php echo $bgcolor;?>" id="<?php echo $data_user['id'];?>">
						...
						<td width="367"  align="left" class="paddLt15 paddBot11 paddTop5" valign="middle"><?php echo ucfirst($data_user['first_name'])." ".$data_user['last_name']; ?></td>
						...
						<td width="367"  align="left" class="paddLt15 paddBot11 paddTop5" valign="middle"><?php echo $data_user['location']; ?></td>
						<td width="367"  align="left" class="paddLt15 paddBot11 paddTop5" valign="middle"><?php echo $data_user['travel_distance']; ?></td>
