	...
	if(isset($_POST['deleteAll']))
	{
		for($i=0;$i<=count($_POST['numbers']);$i++)
		{
			if($_POST['numbers'][$i]!="")
			{
				 ...
				 $sql_multi_delete4 = "DELETE FROM Qualification WHERE id = '".$_POST['numbers'][$i]."'";
...
function DoAction( id )
{
     ...
     $.ajax({
          type: "GET",
          url: "delete_qualification.php?id=" + id,
			...
			<table class="table table-hover" >
			  ...
			  <tr>
				...
				$offset = ($pageNum - 1) * $rowsPerPage; 
					...
					$sql_user = "SELECT * FROM Qualification";
				 ...
				 if($search !='')
					...
					$sql_user = "SELECT * FROM Qualification WHERE Qualification like '".$search."%' ";
				 ...
				 <?php
                   ...
                   <div id="group_1"><table width="100%" cellpadding="0" cellspacing="0" border="0">
                      ...
                      <tr bgcolor="<?php echo $bgcolor;?>">
						...
						<td width="367" align="left" class="paddLt15 paddTopBot5 bodrBot"><strong>
                          <?php 
							...
							{
							?>
                          <img src="images/up.gif" border="0" align="baseline" />&nbsp;<a href="view_qualification.php?sort=1&amp;ord=DESC&amp;page=<?php echo $pageNum;?>">Qualification Name</a>
                          <?php   
							}
							elseif($_GET['ord']=='DESC' && $_GET['sort']=='1')
							{
							?>
                          <img src="images/down.gif"  border="0" align ="baseline" />&nbsp;<a href="view_qualification.php?sort=1&amp;ord=ASC&amp;page=<?php echo $pageNum;?>">Qualification Name</a>
                          <?php
							}
							else
							{
							?>
						  <strong><a href="view_qualification.php?sort=1&amp;ord=DESC&amp;page=<?php echo $pageNum;?>">Qualification Name</a></strong>
						  <?php
							}
							?>
                        </strong></td>
                    ...
                    <tr bgcolor="<?php echo $bgcolor;?>" id="<?php echo $data_user['id'];?>">
						...
						<a  href="edit_qualification.php?id=<?php echo $data_user['id']; ?>&page=<?php echo $pageNum; ?>" ><img src="images/edit1.png" title="Edit Qualification" border="0" style="width:17px; height:17px;" />   </a>	
...
<a href="javascript: VOID(0);" onclick="javascript:if(confirm('Are you sure you want to delete ?')){DoAction('<?php echo $data_user['id'];?>');}"><img src="images/trash.png" title="Delete" border="0"/></a></a>&nbsp;&nbsp;</td>
    ...
    <div class="ie-warning">
        <h1>Warning!!</h1>
        <p>You are using an outdated version of Internet Explorer, please upQualification <br/>to any of the following web browsers to access this website.</p>
