		...
		<form name="frm" method="post">
			<table class="table table-hover" >
			  ...
			  <tr>
				...
				{					
					$sql_user = "SELECT * FROM chat_users_details where tutor_id = '".$_SESSION['loggedIn_user_id']."' and msg_send_user_type <> '".$_SESSION['user_type']."' order by id DESC";
				}
				...
				{					
				 ...
				 if($search !='')
					{ 
						...
						$sql_user = "SELECT * FROM chat_users_details WHERE student_name like '".$search."%' ";
                   ...
                   <div id="group_1"><table width="100%" cellpadding="0" cellspacing="0" border="0">
                      ...
                      <tr bgcolor="<?php echo $bgcolor;?>">
						...
						<td width="367" align="left" class="paddLt15 paddTopBot5 bodrBot"><strong>
                          <?php 
							...
							{
							?>
                          <img src="images/up.gif" border="0" align="baseline" />&nbsp;<a href="view_client_messages.php?sort=1&amp;ord=DESC&amp;page=<?php echo $pageNum;?>">Student Name </a>
                          <?php   
							}
							elseif($_GET['ord']=='DESC' && $_GET['sort']=='1')
							{
							?>
                          <img src="images/down.gif"  border="0" align ="baseline" />&nbsp;<a href="view_client_messages.php?sort=1&amp;ord=ASC&amp;page=<?php echo $pageNum;?>">Student Name</a>
                          <?php
							}
							else
							{
							?>
						  <strong><a href="view_client_messages.php?sort=1&amp;ord=DESC&amp;page=<?php echo $pageNum;?>">Student Name</a></strong>
						  <?php
							}
							?>
                        </strong></td>
						...
						<td width="367"  align="left" valign="middle" class="paddTopBot5 bodrBot"><strong> Tutor</strong></td>
						<td width="367"  align="left" valign="middle" class="paddTopBot5 bodrBot"><strong>Date</strong></td>
                    ...
                    <?php
						...
						while($data_user = mysqli_fetch_array($res_user))
						{
							...
							if($_SESSION['user_type']=='student')
							{					
								//$tutor_name = mysqli_fetch_array($conn->query("SELECT first_name,last_name FROM user_info where user_id = '".$data_user['tutor_id']."' "));
								
								$chat_user_id= 'tutor_id='.$data_user['student_id'];
							}
							if($_SESSION['user_type']=='tutor')
							{					
								$tutor_name = mysqli_fetch_array($conn->query("SELECT first_name,last_name FROM user_info where user_id = '".$data_user['tutor_id']."' "));
								
								$chat_user_id= 'student_id='.$data_user['student_id'];
							}
					...
					?>
						...
						<td width="367"  align="left" class="paddLt15 paddBot11 paddTop5" valign="middle"><?php echo ucfirst($data_user['student_email']); ?></td>
						<td width="367"  align="left" class="paddLt15 paddBot11 paddTop5" valign="middle"><?php echo ucfirst($tutor_name['first_name']." ".$tutor_name['last_name']); ?></td>
						<td width="367"  align="left" class="paddLt15 paddBot11 paddTop5" valign="middle"><?php echo ucfirst($data_user['chat_date']); ?></td>
						
						<td width="144"  align="center" class="paddBot11 paddTop5" valign="middle">
						<a href="chat_user_info.php?<?php echo $chat_user_id; ?>" ><img src="images/chat.png" style="width:22px;" title="Chat Now" border="0"/></a>
						&nbsp;
						
						<a href="javascript: VOID(0);" onclick="javascript:if(confirm('Are you sure you want to delete ?')){DoAction('<?php echo $data_user['id'];?>');}"><img src="images/trash.png" title="Delete" border="0"/></a>&nbsp;&nbsp;</td>
